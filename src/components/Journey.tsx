  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        role: "Lead Developer",
        icon: Globe,
        image: "/media/5.png", // Website/Typing
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        role: "Assistant Planner",
        icon: Map,
        image: "/media/11.jpg", // Logistics/Map
